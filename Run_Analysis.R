...
activity.names <- c("WALKING", "WALKINGUPSTAIRS", "WALKINGDOWNSTAIRS", "SITTING", "STANDING", "LAYING")
...
get.data <- function(dir, name) {
  ...
  cdata <- cbind(clean.data, subject = subjects.t$subject)
